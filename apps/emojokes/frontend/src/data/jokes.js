const ALL_JOKES = [
  ...
  { id: 2,  emoji: '🍕', setup: "Want to hear a joke about pizza?", punchline: "Never mind it's too cheesy." },
  ...
  { id: 67, emoji: '🕰️', setup: "What's the best time to visit the dentist?", punchline: "Tooth-hurty." },
  ...
  { id: 77, emoji: '🏆', setup: "What award do you give a dentist?", punchline: "A little plaque." },
  { id: 78, emoji: '⌚', setup: "What do you call a belt made of watches?", punchline: "A waist of time." },
  { id: 79, emoji: '🎬', setup: "They're making a new movie about clocks.", punchline: "It's about time." },
  { id: 80, emoji: '🐘', setup: "What do you call an elephant that doesn't matter?", punchline: "Irrelephant." },
  { id: 81, emoji: '💻', setup: "What do you call a computer that sings?", punchline: "A Dell." },
  { id: 82, emoji: '🪃', setup: "What do you call a boomerang that doesn't come back?", punchline: "A stick." },
  { id: 83, emoji: '🦆', setup: "What time does a duck wake up?", punchline: "At the quack of dawn." },
  { id: 84, emoji: '🐦', setup: "What do you call a bird that's afraid of heights?", punchline: "A chicken." },
  { id: 85, emoji: '🐩', setup: "What do you call a dog with no legs?", punchline: "Doesn't matter what you call him, he's not coming." },
  { id: 86, emoji: '🎤', setup: "Why does Snoop Dogg carry an umbrella?", punchline: "Fo' drizzle." },
  { id: 87, emoji: '🪟', setup: "I told my doctor I keep thinking I'm a pair of curtains.", punchline: "He told me to pull myself together." },
  { id: 88, emoji: '👟', setup: "I used to work in a shoe recycling shop.", punchline: "It was sole destroying." },
  { id: 89, emoji: '🦩', setup: "My wife told me to stop acting like a flamingo.", punchline: "I had to put my foot down." },
  { id: 90, emoji: '🪂', setup: "Why don't blind people go skydiving?", punchline: "It scares the dog." },
  { id: 91, emoji: '🦮', setup: "I went to a zoo and the only animal was a dog.", punchline: "It was a shih tzu." },
  { id: 92, emoji: '⛪', setup: "A priest, a rabbi and a vicar walk into a bar.", punchline: "The barman says \"Is this some kind of joke?\"" },
  { id: 93, emoji: '💼', setup: "I tried to sue the airport for losing my luggage.", punchline: "I lost my case." },
  { id: 94, emoji: '🎸', setup: "My wife told me to stop singing Wonderwall.", punchline: "I said maaybeee." },
  { id: 95, emoji: '🏰', setup: "I have a lot of growing up to do.", punchline: "I realised that the other day inside my fort." },
  { id: 96, emoji: '🤔', setup: "I used to think I was indecisive.", punchline: "Now I'm not so sure." },
  { id: 97, emoji: '🚲', setup: "Why did the bicycle fall over?", punchline: "It was two-tired." },
  { id: 98, emoji: '🐡', setup: "Two fish in a tank. One says to the other:", punchline: "\"How do you drive this thing?\"" },
  { id: 99, emoji: '🧼', setup: "I used to be addicted to soap.", punchline: "But I'm clean now." },
]
