...
export default function Wunwurd() {
  return (
    <ProjectLayout slug="wunwurd"
      title="Wunwurd"
      subtitle="One word per film"
      tags="Side project, 2025"
    >
      <section>
      ...
      <ImageSection images={[
        { src: `${BASE}/wunwurd01.jpg`, layout: 'full' },
      ]} />
      ...
      <ImageSection images={[
        { src: `${BASE}/wunwurd02.jpg`, layout: 'half' },
        { src: `${BASE}/wunwurd03.jpg`, layout: 'half' },
      ]} />

      <section>
        <h2>One evening with Claude Code</h2>
      ...
      <section>
        ...
        <p><a href="https://www.wunwurd.com" target="_blank" rel="noreferrer">Visit Wunwurd</a></p>
      </section>
    </ProjectLayout>
  )
}
